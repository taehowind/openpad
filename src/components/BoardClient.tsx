...
export function BoardClient({ identifier, mode }: BoardClientProps) {
  ...
  async function copyEntryPassword() {
    ...
    try {
      await navigator.clipboard.writeText(settingsPassword);
